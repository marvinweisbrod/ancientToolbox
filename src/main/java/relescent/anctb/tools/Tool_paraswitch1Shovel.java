...
public class Tool_paraswitch1Shovel extends Tool_toolShovel{

	public Tool_paraswitch1Shovel(ToolMaterial material) {
		super(material);
	}
	
    public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer player)
    {
	    ItemStack newTool = new ItemStack(AddedItems.tool_paraswitch1Pick);
