...
public class Tool_switch2Sword extends Tool_toolSword{

	public Tool_switch2Sword(ToolMaterial material) {
		super(material);
	}
	@Override
    public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer player)
    {
	    ItemStack newTool = new ItemStack(AddedItems.tool_switch2Axe);
