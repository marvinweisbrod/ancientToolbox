...
public class Tool_gluttyswitch1Pick extends Tool_toolPickaxe{

	public Tool_gluttyswitch1Pick(ToolMaterial material) {
		super(material);
	}
    ...
    {
	    ItemStack newTool = new ItemStack(AddedItems.tool_gluttyswitch1Shovel);
