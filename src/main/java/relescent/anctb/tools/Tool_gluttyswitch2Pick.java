...
public class Tool_gluttyswitch2Pick extends Tool_toolPickaxe{

	public Tool_gluttyswitch2Pick(ToolMaterial material) {
		super(material);
	}
    ...
    {
	    ItemStack newTool = new ItemStack(AddedItems.tool_gluttyswitch2Shovel);
