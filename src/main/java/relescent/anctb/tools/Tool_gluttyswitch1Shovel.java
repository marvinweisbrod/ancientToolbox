...
public class Tool_gluttyswitch1Shovel extends Tool_toolShovel{

	public Tool_gluttyswitch1Shovel(ToolMaterial material) {
		super(material);
	}
    ...
    {
	    ItemStack newTool = new ItemStack(AddedItems.tool_gluttyswitch1Pick);
